...
public class ProductDaoMapImpl implements ProductDao{
	...
	public ProductDaoMapImpl() {
		...
		productsMap.put(1, new Product(1, "desktop", new BigDecimal(55000), "Y"));
		productsMap.put(2, new Product(1, "Mouse pad", new BigDecimal(550), "Y"));
		productsMap.put(3, new Product(1, "Torch", new BigDecimal(520), "N"));
		counter=3;
